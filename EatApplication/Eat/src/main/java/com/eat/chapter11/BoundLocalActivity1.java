...
public class BoundLocalActivity1 extends Activity {
    ...
    private static class ServiceListener implements BoundLocalService2.OperationListener {
        ...
        private WeakReference<BoundLocalActivity1> mWeakActivity;

        public ServiceListener(BoundLocalActivity1 activity) {
            this.mWeakActivity = new WeakReference<BoundLocalActivity1>(activity);
        }

        @Override
        public void onOperationDone(final int someResult) {
            final BoundLocalActivity1 localReferenceActivity = mWeakActivity.get();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        bindService(new Intent(BoundLocalActivity1.this, BoundLocalService2.class), mLocalServiceConnection, Service.BIND_AUTO_CREATE);
        mIsBound = true;
    }
    ...
    public void onGotoBoundLocalActivity2(View v) {
